...
internal class Siege
{
    ...
    {
        string[] field = Siege.BuildSignatures;
    ...
    public int KillGuardThread(int lastPid)
    {
        ...
        if (Memory.ProcessId != lastPid)
        {
            ...
            if (num > 0.0)
            {
                Siege.TerminateThread(Siege.OpenThread(2035711L, false, (uint)processThread.Id), 0U);
    ...
    public TreeView BuildGametypeTree()
    {
        ...
        int num12 = -1;
        bool flag2 = false;
        Siege.EventMode @enum = Siege.EventMode.None;
            ...
            case GameBuild.Y3S3_12362767:
                {
                    ...
                    num11 = -1;
                    list.Add(4);
                    @enum = Siege.EventMode.Mad_House;
                    break;
                }
            case GameBuild.Y1S3_9860556:
                {
            ...
            case GameBuild.Y4S1_12863847:
                {
                    ...
                    num11 = -1;
                    list.Add(4);
                    @enum = Siege.EventMode.Rainbow_Is_Magic;
                    break;
                }
            case GameBuild.Y4S3_13632147:
                {
                    ...
                    num11 = -1;
                    list.Add(4);
                    @enum = Siege.EventMode.Doktors_Curse_MoneyHeist;
                    break;
                }
            case GameBuild.Y4S1_12815133:
                {
            ...
            case GameBuild.Y5S1_14303219:
                {
                    ...
                    num5 = 5;
                    num11 = -1;
                    @enum = Siege.EventMode.Grand_Larceny;
                    break;
                }
            case GameBuild.Y1S1_8519860:
                {
        ...
        switch (@enum)
        {
            case Siege.EventMode.Outbreak:
            case Siege.EventMode.Grand_Larceny:
                break;
            case Siege.EventMode.Mad_House:
                ...
                break;
            case Siege.EventMode.Rainbow_Is_Magic:
            ...
            case Siege.EventMode.Showdown:
                ...
                break;
            case Siege.EventMode.Doktors_Curse_MoneyHeist:
                {
            ...
            case Siege.EventMode.Stadium:
                treeView.Nodes[0].Nodes.Add((TreeNode)treeView.Nodes[0].Nodes[5].Nodes[0].Nodes[0].Clone());
                treeView.Nodes[0].Nodes[5].Remove();
                treeView.Nodes[0].Nodes[5].Text = "Road To S.I. 2020";
                break;
            default:
                if (@enum == Siege.EventMode.None)
                {
                }
                break;
        }
